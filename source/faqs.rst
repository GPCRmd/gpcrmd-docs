...
* Q: Why I have not access to some simulations? 
  ...
  * A: Due to protect the unpublished data and save the integrity of copyright, GPCRmd follow a security protocol that only gives the posibility to the user to share this data by a secret submission key and the dynamic id (see https://gpcrmd-docs.readthedocs.io/en/latest/accounts.html#gpcrmd-account-menu, Secret submission key section).
